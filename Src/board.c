...
void init_board(void) {
    ...
    MODIFY_FIELD(GPIOC->MODER, GPIO_MODER_MODER3, ESF_GPIO_MODER_OUTPUT); // AIN1 for motor 2
    MODIFY_FIELD(GPIOC->MODER, GPIO_MODER_MODER2, ESF_GPIO_MODER_OUTPUT); // AIN2 for motor 2
}
